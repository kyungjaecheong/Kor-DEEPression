...
df_drop.to_csv('./data/downloads/ver4/HN_drop_14_20.csv', index=False)
print('Droped nan values successfully')

df_test = pd.read_csv('./data/downloads/ver4/HN_drop_14_20.csv')
...
print('Query & Add Features & Add Targets successfully')

col_year = ['id', 'year']
col_feature = ['id', 'age', 'HE_BMI', 'sex', 'edu', 'household', 'marital', 'EC1_1',
...
df_year.to_csv('./data/downloads/ver4/HN_year.csv', index=False)
df_feature.to_csv('./data/downloads/ver4/HN_feature.csv', index=False)
df_target.to_csv('./data/downloads/ver4/HN_target.csv', index=False)
